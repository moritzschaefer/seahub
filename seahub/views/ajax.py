...
def list_dir(request, repo_id):
    ...
    file_list, dir_list, dirent_more = get_repo_dirents(request, repo,
                                                                  head_commit, path,
                                                                  offset=0, limit=100, with_perm=True)
    if dirent_more:
        more_start = 100
...
def list_dir_more(request, repo_id):
    ...
    file_list, dir_list, dirent_more = get_repo_dirents(request, repo,
                                                                  head_commit, path,
                                                                  offset, limit=100, with_perm=True)
    if dirent_more:
...
def list_lib_dir(request, repo_id):
    ...
    file_list, dir_list, dirent_more = get_repo_dirents(request, repo, head_commit, path, offset, limit=100, with_perm=True)
    more_start = None
    if dirent_more:
        more_start = offset + 100
